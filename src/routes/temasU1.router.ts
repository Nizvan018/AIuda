...
import { definicion_historia, habilidades_proceso, modelo_adquisicion, modelo_agente_inteligente, modelo_cognoscitivo, proceso_razonamiento } from '../controllers/temasU1.controller';
